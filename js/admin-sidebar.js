...
const ICONS = {
  ...
  landing: `<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linejoin="round" stroke-linecap="round"><rect x="6" y="10" width="26" height="26" rx="2" transform="rotate(-6 19 23)"/><rect x="16" y="14" width="26" height="26" rx="2" transform="rotate(6 29 27)"/></svg>`,
...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "landing",   label: "Landing",   href: "admin-landing.html",  icon: ICONS.landing,   gc: "var(--c-galeria)" },
